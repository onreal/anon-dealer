...
.card-icon.turnover { background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); }
...
.forecast-status.healthy { background: #d4edda; color: #155724; }
